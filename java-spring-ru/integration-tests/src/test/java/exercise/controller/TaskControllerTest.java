...
class ApplicationTest {
    ...
    public void testUpdate() throws Exception {
        ...
        data.put("title" , "wash dishes");
        data.put("description", "please do it today");
        ...
        assertThat(task.getTitle()).isEqualTo("wash dishes");
        assertThat(task.getDescription()).contains("please");
    }
